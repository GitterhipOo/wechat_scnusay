...
Page({
    ...
    data: {   
        ...
        postValue: { //打包发送的post数组
            ...
            sharecar_number: "", //人数
            sharecar_time: "", //出发时间
            sharecar_contact: "", //联系方式
            sharecar_space: "", //所在校区
            sharecar_from: "", //出发地点
            sharecar_go:"",//目的地
            sharecar_topic: "", //标题
            sharecar_detail: "", //详情内容
            //photos: [], //放置于主要内容下方的图片
            // tags: ["其他", "生活用品", "夹心糖"], //标签
            readingtimes: 0, //阅读次数
            comments: 0, //评论数量
    ...
    sendToServer() {
        ...
        wx.request({
            ...
            data: {
                ...
                'sharecar_topic': that.data.postValue.sharecar_topic, //标题
                'sharecar_number': that.data.postValue.sharecar_number, //人数
                'sharecar_contact': that.data.postValue.sharecar_contact, //联系方式              
                'sharecar_space': that.data.postValue.sharecar_space, //所在校区
                'sharecar_from': that.data.postValue.sharecar_from, //出发地点
                'sharecar_go': that.data.postValue.sharecar_go, //目的地点
                'sharecar_time': that.data.postValue.sharecar_time, //出发时间
                'sharecar_detail': that.data.postValue.sharecar_detail, //详细内容
