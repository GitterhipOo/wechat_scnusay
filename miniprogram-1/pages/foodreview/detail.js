...
Page({
    ...
    confirm: function (e) {
        ...
        else
        {
            ...
            wx.request({
                url: 'https://www.scnusay.cc/foodreview/foodreviewdetailcomment.php',
                data: {
            ...
            now_reply_type: type, //获取类型(1回复评论/2回复-回复评论)
                ...
                success(res) {
                    ...
                    wx.request({
                        url: 'https://www.scnusay.cc/foodreview/getwhatisendcommentdetail.php',
                        method: 'POST',
                        data: {
                            comment_time: time,
                        },
    ...
    onLoad: function (options) {
        ...
        wx.getStorage({
            ...
            success: function (res) {
                ...
                console.log("缓存已经拿出")
                wx.request({
                    url: 'https://www.scnusay.cc/foodreview/getcommentdetail.php',
                    method: 'POST',
                    data: {
        ...
        wx.removeStorageSync('foodreviewsendPostValue')
    },
